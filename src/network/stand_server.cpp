...
void std_pinfo_display_player_info(net_player *p)
{
	...
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	SDL_snprintf(sml_ping, SDL_arraysize(sml_ping), "%d", (int)(100.0f * ((float)ptr->p_shots_hit / (float)ptr->p_shots_fired)));
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	SDL_snprintf(sml_ping, SDL_arraysize(sml_ping), "%d", (int)(100.0f * ((float)ptr->p_bonehead_hits / (float)ptr->p_shots_fired)));
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	...
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	SDL_snprintf(sml_ping, SDL_arraysize(sml_ping), "%d", (int)(100.0f * ((float)ptr->s_shots_hit / (float)ptr->s_shots_fired)));
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	SDL_snprintf(sml_ping, SDL_arraysize(sml_ping), "%d", (int)(100.0f * ((float)ptr->s_bonehead_hits / (float)ptr->s_shots_fired)));
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	...
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	SDL_snprintf(sml_ping, SDL_arraysize(sml_ping), "%d", (int)(100.0f * ((float)ptr->mp_shots_hit / (float)ptr->mp_shots_fired)));
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	SDL_snprintf(sml_ping, SDL_arraysize(sml_ping), "%d", (int)(100.0f * ((float)ptr->mp_bonehead_hits / (float)ptr->mp_shots_fired)));
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	...
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	SDL_snprintf(sml_ping, SDL_arraysize(sml_ping), "%d", (int)(100.0f * ((float)ptr->ms_shots_hit / (float)ptr->ms_shots_fired)));
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
	SDL_snprintf(sml_ping, SDL_arraysize(sml_ping), "%d", (int)(100.0f * ((float)ptr->ms_bonehead_hits / (float)ptr->ms_shots_fired)));
	Standalone_player_info.append(sml_ping);
	Standalone_player_info.append(",");
