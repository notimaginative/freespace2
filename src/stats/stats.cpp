	...
	switch ( stage ) {
		case MISSION_STATS:
         ...
         // mission primary weapon stats
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.mp_shots_fired);
			gr_printf(sx,sy,text);
			sy += dy;
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.mp_shots_hit);
			gr_printf(sx,sy,text);
			sy += dy;
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.mp_bonehead_hits);
			gr_printf(sx,sy,text);
			sy += dy;
			...
			SDL_snprintf(text,SDL_arraysize(text),"%d",(int)pct); SDL_strlcat(text," %%", SDL_arraysize(text));
			gr_printf(sx,sy,text);
			sy += dy;
			...
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.ms_shots_fired);
			gr_printf(sx,sy,text);
			sy += dy;
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.ms_shots_hit);
			gr_printf(sx,sy,text);
			sy += dy;
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.ms_bonehead_hits);
			gr_printf(sx,sy,text);
			sy += dy;
			...
			SDL_snprintf(text,SDL_arraysize(text),"%d",(int)Active_player->stats.m_assists);
			gr_printf(sx,sy,text);
			sy += 2*dy;
		...
		case ALL_TIME_STATS:
         ...
         // mission kills stats
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.kill_count_ok + add.kill_count_ok);
			hud_num_make_mono(text);
			gr_printf(sx,sy,text);
			// stats_underline_text(sx,sy,text);
			sy += 2*dy;
         // alltime primary weapon stats
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.p_shots_fired + add.p_shots_fired);
			gr_printf(sx,sy,text);
			sy += dy;
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.p_shots_hit + add.p_shots_hit);
			gr_printf(sx,sy,text);
			sy += dy;
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.p_bonehead_hits + add.p_bonehead_hits);
			gr_printf(sx,sy,text);
			sy += dy;
			...
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.s_shots_fired + add.s_shots_fired);
			gr_printf(sx,sy,text);
			sy += dy;
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.s_shots_hit + add.s_shots_hit);
			gr_printf(sx,sy,text);
			sy += dy;
			SDL_snprintf(text,SDL_arraysize(text),"%d",Active_player->stats.s_bonehead_hits + add.s_bonehead_hits);
			gr_printf(sx,sy,text);
			sy += dy;
			...
			// alltime assists
			SDL_snprintf(text,SDL_arraysize(text),"%d",(int)Active_player->stats.assists + add.assists);
			gr_printf(sx,sy,text);
			sy += 2*dy;
