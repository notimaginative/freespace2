...
extern int multi_find_player_by_ship_name(const char *ship_name);
...
extern void fill_net_addr(net_addr_t* addr, ubyte* address, ushort port);
extern char* get_text_address(char * text, const int max_textlen, ubyte * address );
