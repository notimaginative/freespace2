...
The FontTool command line utility can create a VF font file from a correctly formatted PCX file. It also has a simple GUI mode for font kerning of existing/converted VF font files.
