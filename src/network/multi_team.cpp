...
void multi_team_report()
{
	...
	// display scores
	SDL_snprintf(report, SDL_arraysize(report), XSTR("<Team 1 had %d points>", 1275), Multi_team0_score);
	SEND_AND_DISPLAY(report);
	SDL_snprintf(report, SDL_arraysize(report), XSTR("<Team 2 had %d points>", 1276), Multi_team1_score);
	SEND_AND_DISPLAY(report);
